...
<table border="1" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <tr>
    <td height="70" colspan="4" valign="center">
    	<p align="right">垦执拆字[${fns:getCaseIdYear(oaCase.caseDocNo)}]第 ${fns:getCaseId(oaCase.caseDocNo)}号&nbsp;&nbsp; </p>
   </td>
  </tr>
  <tr>
  	<td>
  	...
  	<b>违法事实、相关证据及具体法律规定：</b><br />
  	 ...
  	 &nbsp;&nbsp;&nbsp;&nbsp;依据<u>${oaCase.normCaseDescPart2}</u>之规定。<br />
  	  <b>履行方式、期限和救济途径：</b><br />
  	&nbsp;&nbsp;&nbsp;&nbsp;责令你于<u>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</u>年<u>&nbsp;&nbsp;&nbsp;&nbsp;</u>月<u>&nbsp;&nbsp;&nbsp;&nbsp;</u>日前自行拆除。如不服本拆除决定，可以在收到本
  	决定书之日起60日内向东营市垦利区人民政府申请行政复议，或者自收到本决定书之日起6个月内向东营市垦利区人民法院提起行政诉讼。
	<br />
...
<input type="button" value="现已送达《责令限期拆除决定书》" class="hide" onclick="chufa('${oaCase.id}')" />
</body>
</html>
