	...
	<form:form class="form-horizontal">
		...
		<fieldset>
			...
			<table class="table-form">
				...
				<tr>
					<td class="tit">案件资料</td>
					<td colspan=5>${oaCase.caseAttachmentLinks}</td>
				</tr>						
				<tr>
				...
				<tr>
					...
					<td>
						<c:choose>
						<c:when test="${oaCase.mainLeaderRegApproval==true}"><h4>同意</h4></c:when>
						<c:otherwise><h4>不同意</h4></c:otherwise>
						</c:choose>
					</td>	
				</tr>
				...
				<tr>
					<td colspan=5>${oaCase.assigneePenalOption}</td>
				</tr>	
				<tr>
					<td class="tit">承办机构意见</td>
				...
				<tr>
					...
					<td>
						<c:choose>
						<c:when test="${oaCase.mainLeaderPenalApproval==true}"><h4>同意</h4></c:when>
						<c:otherwise><h4>不同意</h4></c:otherwise>
						</c:choose>
					</td>	
				</tr>
				...
				<tr>
					...
					<td>
						<c:choose>
						<c:when test="${oaCase.mainLeaderCloseCaseApproval==true}"><h4>同意</h4></c:when>
						<c:otherwise><h4>不同意</h4></c:otherwise>
						</c:choose>
					</td>	
				</tr>				
