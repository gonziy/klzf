 ...
 * author Gonziy
 */
package gov.kl.chengguan.modules.gen.web;
...
import gov.kl.chengguan.modules.gen.service.GenSchemeService;
import gov.kl.chengguan.modules.gen.service.GenTableService;
...
public class GenSchemeController extends BaseController {
	...
	public String form(GenScheme genScheme, Model model) {
		if (StringUtils.isBlank(genScheme.getPackageName())){
			genScheme.setPackageName("gov.kl.chengguan.modules");
		}
