 ...
 * author Gonziy
 */
package gov.kl.chengguan.modules.act.service.ext;
...
//		}
		...
		if (user != null) {
			getSystemService().deleteUser(new gov.kl.chengguan.modules.sys.entity.User(user.getId()));
		}
	}
...
//		return getDbSqlSession().selectList("selectGroupsByUserId", userId);
		...
		for (Role role : getSystemService().findRole(new Role(new gov.kl.chengguan.modules.sys.entity.User(null, userId)))){
